 ...
 * methods.
 *
 * <p>Specifically, {@code @FrameworkDeleteMapping} is a <em>composed annotation</em> that
 * acts as a shortcut for {@code @FrameworkMapping(method = RequestMethod.DELETE)}.
 *
